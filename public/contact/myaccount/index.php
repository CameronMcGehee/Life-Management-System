<?php
	...
	echo $adminUIRender->renderAdminHtmlTop('../../', 'Settings for'.htmlspecialchars($currentWorkspace->adminDisplayName), 'Edit your LifeMS workspace.');
			...
			<form class="defaultForm maxHeight" action="./" method="POST" id="editWorkspaceForm">
				...
				<div class="twoColPage-Info-Content maxHeight">
					<div id="twoColInfoWrapper" class="paddingLeftRight90 paddingTopBottom90">
						...
						<h2>Settings: <i><?php echo htmlspecialchars($currentWorkspace->adminDisplayName); ?></i></h2>
					...
					<div id="twoColContentWrapper" class="paddingLeftRight90 maxHeight" style="overflow: auto;">
						<div class="paddingTopBottom90">
							...
							<div class="defaultInputGroup">
								...
								<input class="bigInput" type="text" name="displayName" id="displayName" placeholder="Workspace name..." style="width: 70%;" required value="<?php echo htmlspecialchars($currentWorkspace->displayName); ?>">
								...
								<input class="defaultInput" type="text" name="adminDisplayName" id="adminDisplayName" placeholder="Internal display name..." value="<?php echo htmlspecialchars($currentWorkspace->adminDisplayName); ?>">
								...
								<!-- <div style="border: 1px solid gray; padding: 1em; width: 90%; max-width: 25em; height: 5em;">
									<img src="<?php // if ($currentWorkspace->fullLogoFile === NULL) {echo "../../images/lifems/etc/noLogo.png";} else echo "../../images/lifems/uploads/workspaceFullLogoFile/".htmlspecialchars($currentWorkspace->fullLogoFile); ?>" style="height: 100%; float: left;">
								...
								<div class="twoCol">
									...
									<div>
										...
										<input class="defaultInput" type="text" name="address1" id="address1" placeholder="Address Line 1..." style="width: 90%" value="<?php echo htmlspecialchars($currentWorkspace->address1); ?>">
										...
										<input class="defaultInput" type="text" name="address2" id="address2" placeholder="" style="width: 90%" value="<?php echo htmlspecialchars($currentWorkspace->address2); ?>">
									...
									<div>
										...
										<input class="defaultInput" type="text" name="city" id="city" placeholder="City..." style="width: 90%" value="<?php echo htmlspecialchars($currentWorkspace->city); ?>">
										...
										<div class="twoCol">
											<div>
												...
												<input class="defaultInput" type="text" name="state" id="state" placeholder="State..." style="width: 90%" value="<?php echo htmlspecialchars($currentWorkspace->state); ?>">
											...
											<div>
												...
												<input class="defaultInput" type="number" name="zipCode" id="zipCode" placeholder="Zip code..." style="width: 90%" value="<?php echo htmlspecialchars($currentWorkspace->zipCode); ?>">
								...
								<div class="fourColCompact">
									<div>
										<input class="defaultInput" type="text" name="phonePrefix" id="phonePrefix" placeholder="+1" value="<?php echo htmlspecialchars($currentWorkspace->phonePrefix); ?>" style="width: 1.5em;">
										<span id="phonePrefixError" class="underInputError" style="display: none;"><br>Input a number.</span>
									</div>

									<div>
										<input class="defaultInput" type="text" name="phone1" id="phone1" placeholder="555" value="<?php echo htmlspecialchars($currentWorkspace->phone1); ?>" style="width: 3em;">
										<span id="phone1Error" class="underInputError" style="display: none;"><br>Input a number.</span>
									</div>

									<div>
										<input class="defaultInput" type="text" name="phone2" id="phone2" placeholder="555" value="<?php echo htmlspecialchars($currentWorkspace->phone2); ?>" style="width: 3em;">
										<span id="phone2Error" class="underInputError" style="display: none;"><br>Input a number.</span>
									</div>

									<div>
										<input class="defaultInput" type="text" name="phone3" id="phone3" placeholder="5555" value="<?php echo htmlspecialchars($currentWorkspace->phone3); ?>" style="width: 3em;">
								...
								<?php
									...
									echo $optionsList->create('timeZone', htmlspecialchars($currentWorkspace->timeZone), array('attr' => array('id' => 'timeZone', 'class' => 'defaultInput', 'style' => 'max-width: 100%'), 'with_regions' => false));
							...
							<div class="defaultInputGroup">
								<div class="threeCol">
									<div>
										...
										<input class="defaultInput" type="text" name="currencySymbol" id="currencySymbol" placeholder="$" value="<?php echo htmlspecialchars($currentWorkspace->currencySymbol); ?>" style="width: 1em;">
									...
									<div>
										...
										<input class="defaultInput" type="text" name="areaSymbol" id="areaSymbol" placeholder="ft" value="<?php echo htmlspecialchars($currentWorkspace->areaSymbol); ?>" style="width: 2em;">
									...
									<div>
										...
										<input class="defaultInput" type="text" name="distanceSymbol" id="distanceSymbol" placeholder="mi" value="<?php echo htmlspecialchars($currentWorkspace->distanceSymbol); ?>" style="width: 2em;">
							...
							<div class="defaultInputGroup">
								...
								<div class="threeCol">
									<div>
										<label for="modPayrSalBaseHourlyRate"><p>Default Hourly Rate (<?php echo htmlspecialchars($currentWorkspace->currencySymbol) ?>)</p></label>
										<input class="defaultInput" type="number" min="0" max="99999" step="0.01" name="modPayrSalBaseHourlyRate" id="modPayrSalBaseHourlyRate" placeholder="$0.00" value="<?php echo htmlspecialchars($currentWorkspace->modPayrSalBaseHourlyRate); ?>" style="width: 4em;">
										<span id="modPayrSalBaseHourlyRateError" class="underInputError" style="display: none;"><br>Input a number.</span>
									</div>

									<div>
										<label for="modPayrSalBasePerCalendarEvent"><p>Default Per CalendarEvent Amount (<?php echo htmlspecialchars($currentWorkspace->currencySymbol) ?>)</p></label>
										<input class="defaultInput" type="number" min="0" max="99999" step="0.01" name="modPayrSalBasePerCalendarEvent" id="modPayrSalBasePerCalendarEvent" placeholder="$0.00" value="<?php echo htmlspecialchars($currentWorkspace->modPayrSalBasePerCalendarEvent); ?>" style="width: 4em;">
									...
									<label for="modPayrSalBaseCalendarEventPercent"><p>Default CalendarEvent Percent (%)</p></label>
										<input class="defaultInput" type="number" min="0" max="100" step="1" name="modPayrSalBaseCalendarEventPercent" id="modPayrSalBaseCalendarEventPercent" placeholder="0%" value="<?php echo htmlspecialchars($currentWorkspace->modPayrSalBaseCalendarEventPercent); ?>" style="width: 3em;">
							...
							<div class="defaultInputGroup">
								<div class="twoCol" style="grid-template-columns: 25% 75%;">
									<div>
										...
										<input class="defaultInput" type="number" min="0" step="1" name="docIdMin" id="docIdMin" placeholder="1" value="<?php echo htmlspecialchars($currentWorkspace->docIdMin); ?>" style="width: 4em;">
							...
							<div class="defaultInputGroup">
								<div class="twoCol" style="grid-template-columns: 25% 75%;">
									<div>
										...
										<input class="defaultInput" type="number" min="0" step="1" name="invoiceTerm" id="invoiceTerm" placeholder="None" value="<?php echo htmlspecialchars($currentWorkspace->invoiceTerm); ?>" style="width: 4em;">
										...
										<?php
											...
											foreach ($currentWorkspace->paymentMethods as $paymentMethodId) {
												...
												if ($currentPaymentMethod->existed) {
													...
													<br><br>
													<span id="deletePaymentMethod:::'.htmlspecialchars($paymentMethodId).'" class="smallButtonWrapper orangeButton xyCenteredFlex" style="width: 1em; display: inline;"><img style="height: 1em;" src="../../images/lifems/icons/trash.svg"></span>
													</td>
													<td class="tg-0lax">
							...
							<div class="defaultInputGroup">
								<div class="twoCol" style="grid-template-columns: 25% 75%;">
									<div>
										...
										<input class="defaultInput" type="number" min="0" step="1" name="estimateValidity" id="estimateValidity" placeholder="None" value="<?php echo htmlspecialchars($currentWorkspace->estimateValidity); ?>" style="width: 4em;">
