<?php
	...
	if (!isset($_POST['deleteCalendarEventAuthToken']) || !validateAuthToken($_POST['deleteCalendarEventAuthToken'], 'deleteCalendarEvent')) {
		echo 'tokenInvalid';
		exit();
	}
	...
	useAuthToken($_POST['deleteCalendarEventAuthToken'], 'deleteCalendarEvent');
