...
?>
	...
	<script>
		...
		$(function() {
			...
			// Load customer billing address on load
			$("#billingAddressLoader").load("./includes/customerBillingAddress.inc.php", {
					customerId: '<?php echo htmlspecialchars($_SESSION['ultiscape_customerId']); ?>'
			});
		...
		<div class="cmsMainContentWrapper textColorThemeGray styledText">
				...
				<div class="twoColPage-Content-InfoSmall maxHeight">
					<div id="twoColContentWrapper" class="paddingLeftRight90 maxHeight" style="overflow: auto;">
						...
						<form class="defaultForm" id="invoiceForm">
							...
							<?php
								...
								if ($currentInvoice->existed) {
									echo '<div class="twoCol" style="width: 10em;">';
										echo '<span style="width: 9em;" class="smallButtonWrapper greenButton centered defaultMainShadows" onclick="payInvoiceButton()"><img style="height: 1.2em;" src="../../../images/ultiscape/icons/credit_card.svg"> Pay Invoice</span>';
									echo '</div>';
							...
							<div class="twoCol">
								<div>
									<h3>Invoice #<?php if ((string)$currentBusiness->docIdIsRandom == '1') {echo $currentDocId->randomId;} else {echo $currentDocId->incrementalId;} ?></h3>
								</div>
				...
				<div id="payInvoicePrompt" class="dimOverlay xyCenteredFlex" style="display: none;">
					<div class="popupMessageDialog" style="width: 30em;">
						...
						<label for="payInvoiceMethod"><p style="display: inline;">Method</p> <a href="../../businesssettings/#paymentmethods"><span style="font-size: .75em; width: 20em;" class="extraSmallButtonWrapper orangeButton">Edit Methods</span></a></label>
						<br>
							<?php
						...
						<div id="payInvoiceButtons" class="twoCol centered" style="width: 15em;">
							<div>
								<span id="payInvoiceContinueButton" class="smallButtonWrapper greenButton" onclick="payInvoiceContinue()">Continue <span style="display: none;" id="payInvoiceLoading"><img style="width: 1em;" src="../../../images/ultiscape/etc/loading.gif" class="loadingGif"></span></span>
							</div>
