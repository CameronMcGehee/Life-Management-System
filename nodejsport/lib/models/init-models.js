...
function initModels(sequelize) {
  var admin = _admin(sequelize, DataTypes = Sequelize.DataTypes);
  var adminbusinessbridge = _adminbusinessbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var admincustomerservicemessage = _admincustomerservicemessage(sequelize, DataTypes = Sequelize.DataTypes);
  var adminloginattempt = _adminloginattempt(sequelize, DataTypes = Sequelize.DataTypes);
  var adminsavedlogin = _adminsavedlogin(sequelize, DataTypes = Sequelize.DataTypes);
  var authtoken = _authtoken(sequelize, DataTypes = Sequelize.DataTypes);
  var blogpost = _blogpost(sequelize, DataTypes = Sequelize.DataTypes);
  var blogpostblogtagbridge = _blogpostblogtagbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var blogpostreadtoken = _blogpostreadtoken(sequelize, DataTypes = Sequelize.DataTypes);
  var blogtag = _blogtag(sequelize, DataTypes = Sequelize.DataTypes);
  var business = _business(sequelize, DataTypes = Sequelize.DataTypes);
  var businessplanpayment = _businessplanpayment(sequelize, DataTypes = Sequelize.DataTypes);
  var chemical = _chemical(sequelize, DataTypes = Sequelize.DataTypes);
  var chemicalapplication = _chemicalapplication(sequelize, DataTypes = Sequelize.DataTypes);
  var chemicalchemicaltagbridge = _chemicalchemicaltagbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var chemicalimage = _chemicalimage(sequelize, DataTypes = Sequelize.DataTypes);
  var chemicaltag = _chemicaltag(sequelize, DataTypes = Sequelize.DataTypes);
  var completedjob = _completedjob(sequelize, DataTypes = Sequelize.DataTypes);
  var crew = _crew(sequelize, DataTypes = Sequelize.DataTypes);
  var crewcrewtag = _crewcrewtag(sequelize, DataTypes = Sequelize.DataTypes);
  var crewleaderbridge = _crewleaderbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var crewstaffbridge = _crewstaffbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var crewtag = _crewtag(sequelize, DataTypes = Sequelize.DataTypes);
  var customer = _customer(sequelize, DataTypes = Sequelize.DataTypes);
  var customercustomerservicemessage = _customercustomerservicemessage(sequelize, DataTypes = Sequelize.DataTypes);
  var customercustomertagbridge = _customercustomertagbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var customeremailaddress = _customeremailaddress(sequelize, DataTypes = Sequelize.DataTypes);
  var customeremailaddressemailsendbridge = _customeremailaddressemailsendbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var customerloginattempt = _customerloginattempt(sequelize, DataTypes = Sequelize.DataTypes);
  var customerphonenumber = _customerphonenumber(sequelize, DataTypes = Sequelize.DataTypes);
  var customerphonenumbersmssendbridge = _customerphonenumbersmssendbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var customersavedlogin = _customersavedlogin(sequelize, DataTypes = Sequelize.DataTypes);
  var customerserviceticket = _customerserviceticket(sequelize, DataTypes = Sequelize.DataTypes);
  var customertag = _customertag(sequelize, DataTypes = Sequelize.DataTypes);
  var docid = _docid(sequelize, DataTypes = Sequelize.DataTypes);
  var emailpixel = _emailpixel(sequelize, DataTypes = Sequelize.DataTypes);
  var emailqueuemessage = _emailqueuemessage(sequelize, DataTypes = Sequelize.DataTypes);
  var emailsend = _emailsend(sequelize, DataTypes = Sequelize.DataTypes);
  var emailsubscriptionbridge = _emailsubscriptionbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var emailtemplate = _emailtemplate(sequelize, DataTypes = Sequelize.DataTypes);
  var equipment = _equipment(sequelize, DataTypes = Sequelize.DataTypes);
  var equipmentchemicalbridge = _equipmentchemicalbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var equipmentequipmenttagbridge = _equipmentequipmenttagbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var equipmentimage = _equipmentimage(sequelize, DataTypes = Sequelize.DataTypes);
  var equipmentmaintenancelog = _equipmentmaintenancelog(sequelize, DataTypes = Sequelize.DataTypes);
  var equipmenttag = _equipmenttag(sequelize, DataTypes = Sequelize.DataTypes);
  var estimate = _estimate(sequelize, DataTypes = Sequelize.DataTypes);
  var estimateitem = _estimateitem(sequelize, DataTypes = Sequelize.DataTypes);
  var fileupload = _fileupload(sequelize, DataTypes = Sequelize.DataTypes);
  var invoice = _invoice(sequelize, DataTypes = Sequelize.DataTypes);
  var invoiceitem = _invoiceitem(sequelize, DataTypes = Sequelize.DataTypes);
  var job = _job(sequelize, DataTypes = Sequelize.DataTypes);
  var jobcrewbridge = _jobcrewbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var jobinstanceexception = _jobinstanceexception(sequelize, DataTypes = Sequelize.DataTypes);
  var jobstaffbridge = _jobstaffbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var payment = _payment(sequelize, DataTypes = Sequelize.DataTypes);
  var paymentmethod = _paymentmethod(sequelize, DataTypes = Sequelize.DataTypes);
  var payrolldue = _payrolldue(sequelize, DataTypes = Sequelize.DataTypes);
  var payrollsatisfaction = _payrollsatisfaction(sequelize, DataTypes = Sequelize.DataTypes);
  var property = _property(sequelize, DataTypes = Sequelize.DataTypes);
  var quoterequest = _quoterequest(sequelize, DataTypes = Sequelize.DataTypes);
  var quoterequestservice = _quoterequestservice(sequelize, DataTypes = Sequelize.DataTypes);
  var servicelisting = _servicelisting(sequelize, DataTypes = Sequelize.DataTypes);
  var smssend = _smssend(sequelize, DataTypes = Sequelize.DataTypes);
  var smssubscriptionbridge = _smssubscriptionbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var smstemplate = _smstemplate(sequelize, DataTypes = Sequelize.DataTypes);
  var staff = _staff(sequelize, DataTypes = Sequelize.DataTypes);
  var staffemailaddress = _staffemailaddress(sequelize, DataTypes = Sequelize.DataTypes);
  var staffloginattempt = _staffloginattempt(sequelize, DataTypes = Sequelize.DataTypes);
  var staffphonenumber = _staffphonenumber(sequelize, DataTypes = Sequelize.DataTypes);
  var staffsavedlogin = _staffsavedlogin(sequelize, DataTypes = Sequelize.DataTypes);
  var staffstafftagbridge = _staffstafftagbridge(sequelize, DataTypes = Sequelize.DataTypes);
  var stafftag = _stafftag(sequelize, DataTypes = Sequelize.DataTypes);
  var timelog = _timelog(sequelize, DataTypes = Sequelize.DataTypes);
