<?php
	...
	class adminLoginAttempt {
		...
		public string $originalAdminLoginAttemptId; // Used when updating the table incase the adminLoginAttemptId has been changed after instantiation
		...
		function __construct(string $adminLoginAttemptId = '') {
			...
			// If adminLoginAttemptId does not exist then set the set method type to INSERT and inititialize default values
				...
				$newUuid = new uuid('table', 'adminLoginAttempt', 'adminLoginAttemptId');
				$this->adminLoginAttemptId = $newUuid->generatedId;

				$this->adminId = '';
				$this->loginCode = '';
				$this->dateTimeCodeUsed = '';
				$this->clientIp = NULL;
