	...
	class business {
		...
		public function set() {
			...
			$attr = array(
				...
				'modPayrSalBaseJobPercent' => $this->modPayrSalBaseJobPercent,
				'modPayrSalBasePerJob' => $this->modPayrSalBasePerJob,
				...
				'SZModJobs' => $this->SZModJobs,
				'SZModJobsShowCrewJobs' => $this->SZModJobsShowCrewJobs,
			...
			$attributes = array(
				...
				'modJobs' => $this->db->sanitize($attr['modJobs']),
				...
				'modPayrSalBaseJobPercent' => $this->db->sanitize($attr['modPayrSalBaseJobPercent']),
				'modPayrSalBasePerJob' => $this->db->sanitize($attr['modPayrSalBasePerJob']),
				...
				'SZModJobs' => $this->db->sanitize($attr['SZModJobs']),
				'SZModJobsShowCrewJobs' => $this->db->sanitize($attr['SZModJobsShowCrewJobs']),
				...
				'CPModCZJobs' => $this->db->sanitize($attr['CPModCZJobs']),
