<?php
    ...
    return array(
        'devWelcomeInfo' => '
            <h3>Welcome to Ultiscape!</h3>

            <p>Ultiscape will be an easy-to-use yet fully functional web app for fully automating a lawn/landscaping service business. It will offer:</p>
            ...
            <div style="margin-left: 5ch;">
                ...
                <li>A custom homepage for your business and customer portal for your customers to access their scheduled jobs, invoices, pay online, and more.</li>
            </div>
